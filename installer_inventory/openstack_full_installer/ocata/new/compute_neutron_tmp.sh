...
sed -i "s/#rabbit_host = localhost/rabbit_host = $CONTROL_CTRL_IP\n\
rabbit_userid = openstack\n\
rabbit_password = $PASSWORD/g" /etc/neutron/neutron.conf
sed -i "s/#auth_uri = <None>/auth _uri = http:\/\/$CONTROL_CTRL_IP:5000\n\
...
sed -i "s/#nova_metadata_ip = 127.0.0.1/nova_metadata_ip = $CONTROL_CTRL_IP/g" /etc/neutron/metadata_agent.ini
