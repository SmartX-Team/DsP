...
//	    bpf_trace_printk("STORE \n");
	    ...
	    if (flow_stat) {
            ...
            u64 cur_ipat = flow_stat->last_ts - cur_time;
            ...
            if (cur_ipat < flow_stat->ipat_min) flow_stat->ipat_min = cur_ipat;
            if (cur_ipat > flow_stat->ipat_max) flow_stat->ipat_max = cur_ipat;
