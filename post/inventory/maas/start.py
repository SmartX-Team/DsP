...
class MAASInterface(InstallationToolInterface):
    ...
    def install(self, box_desc, target_software):
        ...
        self._maas_interface = maas_client.connect(self._maas_url, apikey=self._maas_apikey)
    ...
    def _get_machine(self, hostname):
        ...
        machine_list = self._maas_interface.machines.list()
